...
class NullTracerProviderBuilder : public config_sdk::TracerProviderBuilder
{
public:
  std::shared_ptr<opentelemetry::sdk::trace::TracerProvider> Build(
      const config_sdk::TracerProviderBuilderContext &,
      const config_sdk::TracerProviderConfiguration *) const override
  {
    return nullptr;
  }
};

class NullLoggerProviderBuilder : public config_sdk::LoggerProviderBuilder
{
public:
  std::shared_ptr<opentelemetry::sdk::logs::LoggerProvider> Build(
      const config_sdk::LoggerProviderBuilderContext &,
      const config_sdk::LoggerProviderConfiguration *) const override
  {
    return nullptr;
  }
};

class NullMeterProviderBuilder : public config_sdk::MeterProviderBuilder
{
public:
  std::shared_ptr<opentelemetry::sdk::metrics::MeterProvider> Build(
      const config_sdk::MeterProviderBuilderContext &,
      const config_sdk::MeterProviderConfiguration *) const override
  {
    return nullptr;
  }
};
...
TEST(SdkBuilder, InvalidTracerProviderBuilderResult)
{
  auto registry = std::make_shared<config_sdk::Registry>();
  registry->SetTracerProviderBuilder(std::make_unique<NullTracerProviderBuilder>());
  ...
  EXPECT_THROW(builder.CreateConfiguredSdk(model), config_sdk::UnsupportedException);
}

TEST(SdkBuilder, InvalidLoggerProviderBuilderResult)
{
  auto registry = std::make_shared<config_sdk::Registry>();
  registry->SetLoggerProviderBuilder(std::make_unique<NullLoggerProviderBuilder>());
  config_sdk::SdkBuilder builder(registry);
...
TEST(SdkBuilder, InvalidMeterProviderBuilderResult)
{
  auto registry = std::make_shared<config_sdk::Registry>();
  registry->SetMeterProviderBuilder(std::make_unique<NullMeterProviderBuilder>());
  config_sdk::SdkBuilder builder(registry);
