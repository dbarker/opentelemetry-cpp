...
add_thirdparty_package(
  ...
  GIT_TAG "${opentracing-cpp}"
  SUBMODULE_DIR "${PROJECT_SOURCE_DIR}/third_party/opentracing-cpp"
...
if(NOT ${OpenTracing_PROVIDER} STREQUAL "package")
  ...
  if(TARGET opentracing-static AND NOT TARGET OpenTracing::opentracing-static)
    ...
    set_target_properties(opentracing-static PROPERTIES POSITION_INDEPENDENT_CODE ON)
